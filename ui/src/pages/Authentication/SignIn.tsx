...
const SignIn: React.FC = () => {
  ...
  const handleSignIn = async (values: any) => {
    try {
      const response = await userService.userSignIn({ ...values });
      setSnackbarProps({
        isOpen: true,
        alertType: "success",
        message: "Signed in successfully",
      });
      setTimeout(() => navigate("/dashboard/analytics"), 1000);
    } catch (err) {
      setSnackbarProps({
        isOpen: true,
        alertType: "error",
  ...
  return (
    <>
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-dark">
        <div className="flex flex-wrap items-center h-[100vh]">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link
                className="mb-5.5 inline-block text-4xl text-blue-700 font-extrabold"
                to="/"
              >
                JOB ify
              </Link>
              ...
              <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      } w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none  focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary`}
                      id="email"
                      name="email"
